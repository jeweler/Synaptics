$(document).ready(function () {
    ...
    function switch_theme(theme_name) {
        $('#bs-css').attr('href', '/charisma/bootstrap-' + theme_name + '.css');
    }
    ...
    $('ul.main-menu li:not(.nav-header)').hover(function () {
            if ($(this).data('margin') == undefined)
                $(this).data('margin', parseInt($(this).css('margin-left')));
            $(this).stop().animate({'margin-left': parseInt($(this).data('margin')) + 5}, 300);
        },
        function () {
            $(this).stop().animate({'margin-left': parseInt($(this).data('margin'))}, 300);
        });
